...
const flyoutMenuId = document.querySelector('#flyout-menu-items');
...
hamburgerIcon.addEventListener('click', () => {
    ...
    toggleClasses(flyoutMenuId, 'in-view-menuItems', 'out-view-menuItems');
...
Array.from(flyoutMenuItems).slice(0, -1).forEach(fmi => fmi.addEventListener('click', () => {
    flyoutMenuId.classList.remove('in-view-menuItems');
